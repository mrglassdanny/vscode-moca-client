    ...
    var jexcel = (function (el, options) {
        ...
        obj.download = function (includeHeaders) {
            if (obj.options.allowExport == false) {
                ...
                pom.href = url;
                // DG - changing export file name.
                pom.setAttribute('download', "vscode-longbow-moca-client-export_" + (new Date().toLocaleString()) + '.csv');
        ...
        /*
            DG - Below copy methods written by me.
        */


        obj.copy = function (highlighted, delimiter, wNewline, returnData) {
            if (!delimiter) {
                delimiter = "\t";
            }
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    if (!highlighted || obj.records[j][i].classList.contains('highlight')) {
                        ...
                        // Check if value is true or false. If so, replace with 1 or 0.
                        if (value === true) {
                            value = '1';
                        } else if (value === false) {
                            value = '0';
        ...
        obj.copyColumnHeaders = function (returnData) {
            ...
            for (var i = 0; i < obj.options.columns.length; i++) {
                colHeaderTitles.push(obj.options.columns[i].title);
            }

            // Final string
            var str = colHeaderTitles.join(",");
        ...
        obj.copyCsv = function (highlighted, returnData) {
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    if (!highlighted || obj.records[j][i].classList.contains('highlight')) {
                        ...
                        if (!colHeaderTitles.includes(obj.options.columns[i].title)) {
                            colHeaderTitles.push(obj.options.columns[i].title);
                        }
        ...
        obj.copyWithSurround = function (highlighted, delimiter, surround, wNewline, returnData) {
            if (!delimiter) {
                delimiter = "\t";
            }
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    if (!highlighted || obj.records[j][i].classList.contains('highlight')) {
                        ...
                        if (typeof value === "string" && surround === "'") {
                            value = value.replace(new RegExp("'", 'g'), "''");
                        }
                        ...
                        col.push(surround + value + surround);
        ...
        obj.copyPublishData = function (highlighted, delimiter, surround, returnData) {
            if (!delimiter) {
                delimiter = " and ";
            }
            ...
            var y = obj.options.data.length
            var tmp = '';
            var colHeaders = obj.options.columns;
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    if (!highlighted || obj.records[j][i].classList.contains('highlight')) {
                        ...
                        col.push(colHeaders[i].title + " = " + (surround + value + surround));
                ...
                if (col.length) {
                    row.push("publish data where " + col.join(delimiter));
                }
            }
        ...
        obj.copyWhereClause = function (highlighted, delimiter, surround, returnData) {
            if (!delimiter) {
                delimiter = " and ";
            }
        ...
        obj.copyWhereClauseMocaVars = function (highlighted, delimiter, returnData) {
            if (!delimiter) {
                delimiter = " and ";
            }
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    if (!highlighted || obj.records[j][i].classList.contains('highlight')) {
                        ...
                        col.push(colHeaders[i].title + " = @" + colHeaders[i].title);
        ...
        obj.copyInsertClause = function (highlighted, returnData) {
            ...
            for (var j = 0; j < y; j++) {
                ...
                if (col.length) {
                    row.push("[insert into my_table(" + colHeaderTitles.join(",") + ") values(" + col.join(",") + ")]");
                }
            }
        ...
        obj.copyInsertClauseMocaVars = function (highlighted, returnData) {
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    if (!highlighted || obj.records[j][i].classList.contains('highlight')) {
                        ...
                        if (!colHeaderTitles.includes(obj.options.columns[i].title)) {
                            colHeaderTitles.push(obj.options.columns[i].title);
                            colHeaderTitlesWMocaVars.push("@" + obj.options.columns[i].title);
                        }
                ...
                if (col.length) {
                    row.push("[insert into my_table(" + colHeaderTitles.join(",") + ") values(" + colHeaderTitlesWMocaVars.join(",") + ")]");
                }
        ...
        if (options && options.contextMenu != null) {
            ...
            obj.options.contextMenu = function (el, x, y, e) {
                ...
                items.push({
                    title: 'Copy: Comma - Single Quote',
                    shortcut: 'Ctrl + Shift + C',
                    onclick: function () {
                        obj.copyWithSurround(true, ',', "'");
                    }
                });
                items.push({
                    title: 'Copy: Comma - Single Quote w Newline',
                    onclick: function () {
                        obj.copyWithSurround(true, ',', "'", true);
                    }
                });
                items.push({
                    title: 'Copy: Comma - Double Quote',
                    onclick: function () {
                        obj.copyWithSurround(true, ',', `"`);
                    }
                });
                items.push({
                    title: 'Copy: Comma - Double Quote w Newline',
                    onclick: function () {
                        obj.copyWithSurround(true, ',', `"`, true);
                    }
                });
                ...
                items.push({
                    title: 'Copy: Insert Clause - MOCA Variables',
                    shortcut: 'Ctrl + Shift + I',
                    onclick: function () {
                        obj.copyInsertClauseMocaVars(true);
                    }
                });
                items.push({
                    title: 'Copy: Insert Clause - Single Quote',
                    shortcut: 'Ctrl + I',
                    onclick: function () {
                        obj.copyInsertClause(true);
                    }
                });
                items.push({
                    title: 'Copy: Publish Data - Single Quote',
                    onclick: function () {
                        obj.copyPublishData(true, ' and ', `'`);
                    }
                });
                items.push({
                    title: 'Copy: Where Clause - MOCA Variables',
                    shortcut: 'Ctrl + Shift + W',
                    onclick: function () {
                        obj.copyWhereClauseMocaVars(true, ' and ');
                    }
                });
                items.push({
                    title: 'Copy: Where Clause - Single Quote',
                    shortcut: 'Ctrl + W',
                    onclick: function () {
                        obj.copyWhereClause(true, ' and ', `'`);
                    }
                });
                ...
                if (obj.options.allowExport) {
                    items.push({
                        // DG - changing text so the user knows export ends up in Downloads.
            ...
            if (!jexcel.current.edition && jexcel.current.selectedCell) {
                ...
                if (e.which == 37) {
                    ...
                    if ((e.ctrlKey || e.metaKey) && !e.shiftKey) {
                        ...
                        // DG - Adding more hot key functionality.
                        else if (e.which == 73) {
                            // Ctrl + I
                            jexcel.current.copyInsertClause(true);
                            e.preventDefault();
                        } else if (e.which == 87) {
                            // Ctrl + W
                            jexcel.current.copyWhereClause(true, ' and ', `'`);
                            e.preventDefault();
                        }
                    } else {
                        ...
                        if ((e.ctrlKey || e.metaKey) && e.shiftKey) {
                            if (e.which == 67) {
                                // Ctrl + Shift + C
                                jexcel.current.copyWithSurround(true, ',', "'");
                                e.preventDefault();

                            } else if (e.which == 73) {
                                // Ctrl + Shift + I
                                jexcel.current.copyInsertClauseMocaVars(true);
                                e.preventDefault();

                            } else if (e.which == 87) {
                                // Ctrl + Shift + W
                                jexcel.current.copyWhereClauseMocaVars(true, ' and ');
                                e.preventDefault();
